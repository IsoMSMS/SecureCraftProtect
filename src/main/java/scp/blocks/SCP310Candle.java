...
//	}
	...
	public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
	{
		...
		for (var7 = 0; var7 < 7; ++var7)
		{
			...
			if (var8 == 0)
			{
				...
				{
					par1World.setBlock(par2, par3, par4, SCPBlocks.blockSCP310Fire.blockID);
					return;
				}
			}
		...
		if (var6 == 0)
		{
			...
			for (int var9 = 0; var9 < 3; ++var9)
			{
				...
				{
					par1World.setBlock(par2, par3 + 1, par4, SCPBlocks.blockSCP310Fire.blockID);
				}
			}
		}
	}
	...
	{
		var1.setBlock(var2 + 1, var3 - 1, var4, SCPBlocks.blockSCP310Fire.blockID);
		var1.setBlock(var2 - 1, var3 - 1, var4, SCPBlocks.blockSCP310Fire.blockID);
		var1.setBlock(var2, var3 - 1, var4 + 1, SCPBlocks.blockSCP310Fire.blockID);
		var1.setBlock(var2, var3 - 1, var4 - 1, SCPBlocks.blockSCP310Fire.blockID);
		return true;
	}
}
