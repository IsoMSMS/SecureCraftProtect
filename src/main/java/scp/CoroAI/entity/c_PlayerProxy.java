...
import scp.c_CoroAIUtil;
import scp.c_EntInterface;
import scp.CoroAI.Behaviors;
import scp.CoroAI.PFQueue;
import scp.CoroAI.PathEntityEx;
import scp.CoroAI.c_IEnhPF;
...
public class c_PlayerProxy extends c_EntInterface implements c_IEnhPF {
    ...
    public boolean interact(EntityPlayer var1) {
    	//Minecraft.getMinecraft().displayGuiScreen(new GuiTrade(this.inventory, var1.inventory));
    	return false;
    }
